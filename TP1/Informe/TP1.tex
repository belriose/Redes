...
ACA EXPLICAR BREVEMENTE EL CALCULO DE ENTROPIA DEL CODIGO
...
\begin{figure}[!hbp]
\begin{center}
\includegraphics[width=11cm]{ActividadIPsSolicitadas.eps}
\end{center}
...
\begin{figure}[!hbp]
\begin{center}
\includegraphics[width=11cm]{HistIPsSolicitadas.eps}
\end{center}
...
\begin{figure}[!hbp]
\begin{center}
\includegraphics[width=11cm]{ActividadIPsOrigen.eps}
\end{center}
...
\begin{figure}[!hbp]
\begin{center}
\includegraphics[width=11cm]{HistIPsOrigen.eps}
\end{center}
